...
const FA: Dict = {
  ...
  'tour.welcome.say': 'به Triage-Link خوش آمدید. شما را در ثبت یک مصدوم راهنمایی می‌کنم. روی صفحه دنبال کنید یا «بعدی» را بزنید.',
  'tour.palette.title': 'نوع آسیب را انتخاب کنید',
  'tour.palette.say': 'ابتدا یک نوع آسیب را از این پالت انتخاب کنید — مثلاً پارگی یا سوختگی.',
  'tour.charts.title': 'روی بدن مشخص کنید',
  'tour.charts.say': 'روی ناحیه‌ای از بدن بزنید تا بزرگ شود، سپس دوباره بزنید تا نشانگر را دقیقاً روی محل آسیب بگذارید.',
  'tour.editor.title': 'جزئیات را اضافه کنید',
  'tour.editor.say': 'برای آسیب انتخاب‌شده، شدت آن را تنظیم کنید، یادداشت بیفزایید و با دوربین عکس زخم را پیوست کنید.',
  'tour.triage.title': 'تریاژ را تعیین کنید',
  'tour.triage.say': 'سطح تریاژ بیمار را تعیین کنید. روی کارت مصدوم و تابلوی تریاژ نمایش داده می‌شود.',
  'tour.vitals.title': 'علائم حیاتی را ثبت کنید',
  'tour.vitals.say': 'یک مجموعه علائم حیاتی زمان‌دار را اینجا ثبت کنید. در هر ارزیابی مجدد یک مجموعه تازه بیفزایید.',
  'tour.summary.title': 'تحویل',
  'tour.summary.say': 'هنگام تحویل، خلاصه را باز کنید تا یک کارت مصدوم تک‌صفحه‌ای را به‌صورت PDF چاپ یا ذخیره کنید.',
  'tour.board.title': 'کل صحنه را ببینید',
  'tour.board.say': 'با چند مصدوم، تابلو همه را بر اساس تریاژ گروه‌بندی می‌کند — نمای صحنه برای فرماندهی.',
  'tour.done.title': 'آماده‌اید',
  'tour.done.say': 'این جریان اصلی است. همه‌چیز به‌صورت آفلاین روی این دستگاه ذخیره می‌شود. می‌توانید این تور را هر زمان از دکمه راهنما دوباره ببینید.',
  'tomb.title': 'هویت',
  'tomb.name': 'نام کامل',
