...
| **Encryption at rest** | Opt-in vault encrypts records, op-log, and photos + passphrase-encrypted backups | Always-on encrypted device store + encrypted backend/backups _(build: Phase 3)_ | ★★★ |
